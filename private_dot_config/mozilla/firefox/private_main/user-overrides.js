...
user_pref("browser.newtabpage.enabled", false); //enabled non-empty ntp-s
user_pref("browser.download.useDownloadDir", false); //always download files to the System Download Directory
user_pref("browser.urlbar.suggest.searches", false);//enables search suggestions in the url-bar
