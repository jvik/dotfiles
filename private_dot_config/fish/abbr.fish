...
abbr -a sysup 'ANSIBLE_STDOUT_CALLBACK=yaml ansible-playbook --ask-become-pass -i localhost, -c local ~/.bootstrap/update.yml'
abbr -a sysup-all 'ANSIBLE_STDOUT_CALLBACK=yaml ansible-playbook --ask-become-pass -i localhost, -c local ~/.bootstrap/update.yml --tags system,brew,uv,npm,mise,fisher'
abbr -a sysup-check 'ANSIBLE_STDOUT_CALLBACK=yaml ansible-playbook --ask-become-pass -i localhost, -c local ~/.bootstrap/update.yml --tags check'
